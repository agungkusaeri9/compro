    ...
    <div class="section section-3" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="destination-slider-wrap">
            <div class="destination-slider">
                ...
                <div class="destination">
                    <div class="thumb">
                        <img src="{{ asset('assets/frontend') }}/images/img-2.jpg" alt="Image" class="img-fluid">
                ...
                <div class="destination">
                    <div class="thumb">
                        <img src="{{ asset('assets/frontend') }}/images/img-3.jpg" alt="Image" class="img-fluid">
                ...
                <div class="destination">
                    <div class="thumb">
                        <img src="{{ asset('assets/frontend') }}/images/img-4.jpg" alt="Image" class="img-fluid">
                        <div class="price">$490</div>
                    </div>
                    <div class="mt-4">
                        <h3><a href="#">Paradise Beach, Palawan Island</a></h3>
                ...
                <div class="destination">
                    <div class="thumb">
                        <img src="{{ asset('assets/frontend') }}/images/img-5.jpg" alt="Image" class="img-fluid">
                        <div class="price">$430</div>
                    </div>
                    <div class="mt-4">
                        <h3><a href="#">Paradise Beach, Palawan Island</a></h3>
                ...
                <div class="destination">
                    <div class="thumb">
                        <img src="{{ asset('assets/frontend') }}/images/img-6.jpg" alt="Image" class="img-fluid">
                        <div class="price">$560</div>
                    </div>
                    <div class="mt-4">
                        <h3><a href="#">Paradise Beach, Palawan Island</a></h3>
                ...
                <div class="destination">
                    <div class="thumb">
                        <img src="{{ asset('assets/frontend') }}/images/img-7.jpg" alt="Image" class="img-fluid">
                        <div class="price">$490</div>
                    </div>
                    <div class="mt-4">
                        <h3><a href="#">Paradise Beach, Palawan Island</a></h3>
            ...
            <div class="wide-slider-testimonial">
                <div class="item">
                    <blockquote class="block-testimonial">
                        <div class="author">
                            <img src="{{ asset('assets/frontend') }}/images/person_1.jpg"
            ...
            <div class="row align-items-stretch">
                <div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
                    <div class="media-entry">
                        <a href="#">
                            <img src="{{ asset('assets/frontend') }}/images/gal_1.jpg" alt="Image" class="img-fluid">
                        </a>
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="media-entry">
                        <a href="#">
                            <img src="{{ asset('assets/frontend') }}/images/gal_2.jpg" alt="Image" class="img-fluid">
                        </a>
                        <div class="bg-white m-body">
                            <span class="date">May 14, 2020</span>
                            <h3><a href="#">Far far away, behind the word mountains</a></h3>
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
                    <div class="media-entry">
                        <a href="#">
                            <img src="{{ asset('assets/frontend') }}/images/gal_3.jpg" alt="Image" class="img-fluid">
                        </a>
                        <div class="bg-white m-body">
                            <span class="date">May 14, 2020</span>
                            <h3><a href="#">Far far away, behind the word mountains</a></h3>
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
                    <div class="media-entry">
                        <a href="#">
                            <img src="{{ asset('assets/frontend') }}/images/gal_4.jpg" alt="Image" class="img-fluid">
                        </a>
                        <div class="bg-white m-body">
                            <span class="date">May 14, 2020</span>
                            <h3><a href="#">Far far away, behind the word mountains</a></h3>
